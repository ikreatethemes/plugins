 ...
 *
 */
class IKDI_Customizer_Importer {
    /**
    ...
    public static function import($customizerFile, $excludeImages) {
        ...
        if ('array' != gettype($data)) {
            $error = esc_html__('Error importing settings! Please check that you uploaded a customizer export file.', 'ikreate-demo-importer');
            return;
        }
        ...
        if ($data['template'] != $template) {
            $error = esc_html__('Error importing settings! The settings you uploaded are not for the current theme.', 'ikreate-demo-importer');
            return;
        }
        ...
        if (isset($data['options'])) {
            ...
            foreach ($data['options'] as $option_key => $option_value) {
                $option = new IKDI_Customzer_Option($wp_customize, $option_key, array(
                    'default' => '',
                    'type' => 'option',
